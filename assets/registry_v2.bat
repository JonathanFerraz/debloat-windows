...
@REM sc config XblAuthManager start=disabled >nul 2>&1
@REM sc stop XblGameSave >nul 2>&1
@REM sc config XblGameSave start=disabled >nul 2>&1
@REM sc stop XboxGipSvc >nul 2>&1
@REM sc config XboxGipSvc start=disabled >nul 2>&1
@REM sc stop XboxNetApiSvc >nul 2>&1
@REM sc config XboxNetApiSvc start=disabled >nul 2>&1
@REM echo  %p%[ %roxo%•%p% %p%]%w% Xbox Services disabled. %p%(%roxo%8%p%)%w%
